...
// https://github.com/octokit/rest.js/blob/master/HOW_IT_WORKS.md
...
module.exports = {
  ...
  getRepos : async () => octokit.paginate(octokit.repos.listForAuthenticatedUser, {}),
//    const repos = await octokit.paginate(octokit.repos.getAll, {});
    //return repos;
//  },

  getBranches : async (repo) => await octokit.paginate(octokit.repos.getBranches,{owner:creds.username, repo}),
